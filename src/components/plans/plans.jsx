...
const Plans = () => {
    ...
    const handleChekout = async (priceId) => {
        if (userSubscription?.status === "active") {
            ...
            alert("Loading Checkout please wait")
            // setIsLoading(true)
                    ...
                    Object.entries(products).map(([productId, productData]) => {
                        ...
                        return (
                            ...
                            <div className="plans__container" key={productId}>
                                ...
                                <button className={`subscribe__btn ${subscribed ? "unsubscribe" : ""}`} onClick={() => handleChekout(productData.prices.priceId)}>{subscribed ? "unsubscribe" : 
                                     "subscribe"
                            }</button>
                            </div>
